...
_HERMES_BEHAVIORAL_VARS = frozenset({
    ...
    "HERMES_POSTGRES_MIRROR_ENABLED",
    "HERMES_POSTGRES_DSN",
    "HERMES_POSTGRES_SCHEMA",
    "HERMES_POSTGRES_HOME_KEY",
    "HERMES_POSTGRES_STRICT",
    "HERMES_POSTGRES_CONNECT_TIMEOUT",
    "HERMES_POSTGRES_STATEMENT_TIMEOUT_MS",
    "TERMINAL_CWD",
    "TERMINAL_ENV",
